...
* 2017: $737.717  
cd "C:\Users\Juan Pablo\Documents\GEIH 2017"
...
merge 1:1 llavepersona using ocup2017
...
replace possalario="Menos de 1 SMLV"  if (p6500 <  737717)
replace possalario="Entre 1-2 SMLV"  if (p6500 >= 737717   &  p6500 <= 737717*2)
replace possalario="Mas de 2 SMLV"  if (p6500 > 2*737717   &  p6500!=.) 

gen incidenciamodal=.

replace incidenciamodal=0  if possalario!=""
replace incidenciamodal=1  if (p6500> 0.95*737717  & p6500 <=  1.05*737717)
